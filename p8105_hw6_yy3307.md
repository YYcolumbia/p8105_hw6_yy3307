...
1.75. New York, NY has the lowest odds ratio and Albuquerque, NM has the
highest odds ratio. We can also tell that the confidence interval for
each city does not follows a specific increasing trend, some cities may
have low OR with long CI and some may have high OR with shortter CI.
