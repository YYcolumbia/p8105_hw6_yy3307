...
change the numeric to the corresponding expression first using `recode`,
so that I can more directly recognize the representation. Then we can
use `as.factor` to change them into factors.
